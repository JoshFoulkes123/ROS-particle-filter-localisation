...
class ParticleFilterLocalisationNode(object):
    def __init__(self):
        ...
        self._PUBLISH_DELTA = rospy.get_param("publish_delta", 0.3)
    ...
    def _initial_pose_callback(self, pose):
        ...
        self.PC = self._particle_filter.particlecloud
        self._cloud_publisher.publish(self.PC)
    ...
    def _sufficientMovementDetected(self, latest_pose):
        ...
        return (location_delta > self._PUBLISH_DELTA*4 or
